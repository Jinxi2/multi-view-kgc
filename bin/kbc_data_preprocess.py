    ...
    for input_file in all_files:
        ...
        with open(input_file, "r") as f:
            for line in f.readlines():
                ...
                relation_lst['neg_' + tokens[1]] = len(relation_lst)
...
def write_vocab(output_file, entity_lst, relation_lst):
    ...
    for r in relation_lst.keys():
        fout.write(r + "\n")
    vocab_size = 103 + len(entity_lst) + len(relation_lst)
...
def write_true_triples(train_file, dev_file, test_file, vocab, output_file):
    train_file = 'data/fb15k237/train.txt'
    dev_file = 'data/fb15k237/valid.txt'
    test_file = 'data/fb15k237/test.txt'
    true_triples = []
    all_files = [train_file, dev_file, test_file]
    for input_file in all_files:
        with open(input_file, "r") as f:
